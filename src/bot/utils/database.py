...
async def init_db():
    ...
    try:
        ...
        # Заполняем услуги
        services = [
            (1, "💉 Ботокс", 200, "Точечная работа с мимическими морщинами. Расслабляем мышцы, сохраняем естественную мимику, освежаем взгляд и делаем лицо более расслабленным. Эффект — до 4–6 месяцев."),
            (2, "💧 Рост волос под плазмой", 3500, "Стимулируем рост волос с помощью холодной плазмы. Без боли, без реабилитации. Уже после 3 сеансов — меньше выпадения и больше густоты."),
            (3, "🔁 Перезагрузка кожи", 3000, "Глубокий пилинг, подобранный под ваш тип кожи. Снимаем усталость, тусклость и неровный тон. Кожа сияет уже после первого сеанса."),
            (4, "✨ Пилинг с ретинолом", 4000, "Антивозрастной пилинг, который разглаживает мелкие морщинки, улучшает текстуру и делает кожу упругой. Для тех, кто хочет выглядеть на 5 лет моложе."),
            (5, "💎 Глубокое очищение", 3500, "Комбинированная чистка на профессиональной косметике Christina (Израиль). Избавляем от чёрных точек, акне и расширенных пор. Кожа дышит и сияет."),
            (6, "⚡ Кислородный всплеск", 2500, "Карбокситерапия — мощный заряд CO₂ для кожи. Уходит тусклость, появляется сияние и здоровый цвет лица. Как после отпуска!"),
            (7, "🌙 Молодая кожа без игл", 3500, "Холодная плазма для лица и шеи. Безинъекционное омоложение: подтягиваем овал, улучшаем упругость, уменьшаем морщины."),
            (8, "🧖‍♀️ Шея", 1500, "Уход за зоной шеи — деликатной и склонной к раннему старению. Улучшаем тонус, увлажняем, выравниваем текстуру."),
            (9, "🤍 Декольте", 1500, "Уход за зоной декольте — часто забываемой, но очень заметной. Увлажняем, выравниваем тон, убираем пигментацию."),
            (10, "🤲 Руки красоты", 2500, "Ваши руки расскажут о вас больше, чем вы думаете. Восстановим упругость, уберём пигментацию и сухость."),
            (11, "🌞 Плоский живот", 2500, "Процедура для упругости и тонуса кожи живота. Подходит после родов или снижения веса."),
            (12, "✅ Чистая кожа", 300, "Аккуратное удаление папилом. Без шрамов, безопасно, быстро."),
            (13, "🩹 Удаление шипиц", 350, "Эффективное и щадящее удаление шипиц. Не оставляет следов, заживление за 3–5 дней."),
            (14, "✨ Жена миллионера", 8000, "Биоревитализация — инъекции гиалуроновой кислоты для глубокого увлажнения и сияния кожи. Как после СПА на 2 недели вперед. Препарат подбирается индивидуально."),
            (15, "🌺 Monaco Filorga", 0, "омплексная омолаживающая процедура на премиальной косметике Filorga. Сочетание 24 витаминов и минералов + ботулинический компонент для глубокого увлажнения, лифтинга и улучшения тургора кожи. Возрастной подход, который работает мягко и эффективно."),
            (16, "💬 Консультация по омоложению", 0, "Запишитесь на бесплатную консультацию — обсудим, какие процедуры подойдут именно вам. Без навязывания."),
            (17, "💋 Коррекция губ", 0, "Подберём идеальный объём и форму. Натурально, красиво, без перебора."),
            (18, "🔄 Филлеры", 0, "Индивидуальный подход. Только то, что нужно — без лишнего.")
        ]
